        ...
        <div class="row">  
            ...
            <div class="col-md-6">  
                <div class="product-main-image">  
                    <img src="{{ url_for('static', filename=product['image_path']) }}" class="img-fluid" alt="{{ product['title'] }}">  
                </div>  
                <div class="product-thumbnails mt-3">  
                    <div class="row">  
                        <div class="col-3">  
                            <img src="{{ url_for('static', filename=product['image_path']) }}" class="img-fluid thumbnail" alt="{{ product['title'] }}">  
                        </div>  
                        <div class="col-3">  
                            <img src="{{ url_for('static', filename=product['image_path']) }}" class="img-fluid thumbnail" alt="{{ product['title'] }}">  
                        </div>  
            ...
            <div class="col-md-6">  
                ...
                <div class="vendor-info d-flex align-items-center">  
                    <img src="{{ url_for('static', filename=product['store_logo']) }}" alt="{{ product['store_name'] }}" class="store-logo" style="width: 40px; height: 40px; border-radius: 50%; margin-right: 10px;">  
            ...
            <div class="col-md-12">  
                ...
                <div class="reviews">  
                    ...
                    <div class="review-item d-flex align-items-start mb-4">  
                        <img src="{{ url_for('static', filename=review['user_profile_image']) }}" alt="{{ review['user_name'] }}" class="user-profile-image" style="width: 40px; height: 40px; border-radius: 50%; margin-right: 10px;">  
