...
<head>
        ...
        <link rel="stylesheet" href="{{ url_for('static', filename='public/css/admin_page.css') }}">
        <title>Doogo</title>
    </head>
<body>
<header class="bg-custom text-white">
    ...
    <div class="admin-dashboard-container mt-5">
        ...
        <div class="text-center">
            <a href="/seller" class="btn btn-primary">Add Product</a>
            <a href="/manage_products" class="btn btn-primary">Manage Products</a>
            <a href="/admin_chat" class="btn btn-secondary">Help Chat</a>
        </div>
    </div>
